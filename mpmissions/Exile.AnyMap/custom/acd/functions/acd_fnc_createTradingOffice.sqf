...
if(_Armory)then{
	...
	_Armory_sign = _Armory_class createVehicle _pos;      
...
if(_Equipment)then{
	...
	_Equipment_sign = _Equipment_class createVehicle _pos;
...
_Hardware_sign = _Hardware_class createVehicle _pos;      
...
if(_Office)then{
	...
	_Office_sign = _Office_class createVehicle _pos;
	...
	_Office_Table = _Office_Table_class createVehicle _pos;
...
if(_SpecialOperations)then{
	...
	_SpecialOperations_sign = _SpecialOperations_class createVehicle _pos;
...
if(_Vehicle)then{
	...
	_Vehicle_addon = _Vehicle_addon_class createVehicle _pos;      
	...
	_Vehicle_sign = _Vehicle_sign_class createVehicle _pos;      
	...
	_Vehicle_chair = _Vehicle_chair_class createVehicle _pos;      
...
if(_WasteDump)then{
	...
	_WasteDump_sign = _WasteDump_sign_class createVehicle _pos;      
	...
	_WasteDump_prop1 = _WasteDump_prop1_class createVehicle _pos;      
	...
	_WasteDump_prop2 = _WasteDump_prop2_class createVehicle _pos;      
